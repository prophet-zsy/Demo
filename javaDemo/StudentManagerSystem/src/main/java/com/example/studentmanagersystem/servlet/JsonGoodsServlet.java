...
@WebServlet(name = "JsonGoodsServlet", value = "/goods_list")
public class JsonGoodsServlet extends HttpServlet {  // 这里没有实现该方法，直接用，使用默认实现
...
//        设定编码
        ...
        String path = req.getSession().getServletContext().getRealPath("/goods_list.json");
